...
function mapbox_export_mesa_library_path {
    ...
    mason install mesa 13.0.3-dynamic-llvm
    export LD_LIBRARY_PATH="`mason prefix mesa 13.0.3-dynamic-llvm`/lib:${LD_LIBRARY_PATH:-}"
    export LIBGL_DRIVERS_PATH="`mason prefix mesa 13.0.3-dynamic-llvm`/lib/dri"
}
